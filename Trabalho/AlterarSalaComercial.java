...
public class AlterarSalaComercial extends JFrame {
	...
	private JButton btnAlterarSalaComercial;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AlterarSalaComercial frame = new AlterarSalaComercial();
	 ...
	 * Create the frame.
	 */
	public AlterarSalaComercial() {
		setTitle("Altera Sala Comercial");
		...
		btnAlterarSalaComercial = new JButton("Salvar");
		btnAlterarSalaComercial.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(e.getSource() == btnAlterarSalaComercial) {
					...
					AlterarSalaComercial.this.dispose();
					
					UIManager.put("OptionPane.minimumSize", new Dimension(220, 200));
					JOptionPane.showMessageDialog(null, salaComercial.toString(), "Dados cadastrados:", JOptionPane.PLAIN_MESSAGE);
			}
		}});
		btnAlterarSalaComercial.setBounds(15, 88, 286, 29);
