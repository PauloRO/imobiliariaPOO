...
public class AlterarResidencial extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AlterarResidencial frame = new AlterarResidencial();
	 ...
	 * Create the frame.
	 */
	public AlterarResidencial() {
		setTitle("Altera Residencial");
		...
		btnAlterarCasa.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AlterarCasa casa = new AlterarCasa();
				casa.setVisible(true);
				AlterarResidencial.this.dispose();
			}
		});
		btnAlterarCasa.setBounds(15, 359, 300, 29);
		...
		btnAlterarApartamento.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				AlterarApartamento apartamento = new AlterarApartamento();
				apartamento.setVisible(true);
				AlterarResidencial.this.dispose();
			}
		});
		btnAlterarApartamento.setBounds(15, 314, 300, 29);
		contentPane.add(btnAlterarApartamento);
		
		btnAlterarResidencial = new JButton("Salvar residencial");
		btnAlterarResidencial.setEnabled(false);
		btnAlterarResidencial.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {		
				if(e.getSource() == btnAlterarResidencial) {									
		...
		btnAlterarResidencial.setBounds(15, 269, 300, 29);
