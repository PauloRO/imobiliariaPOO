...
public class CadastrarImovel extends JFrame {
	...
	public CadastrarImovel() {		
		...
		btnCadastrarResidencial.setBounds(15, 483, 300, 29);
		...
		btnCadastrarCasa.setBounds(15, 563, 300, 29);
		contentPane.add(btnCadastrarCasa);
		
		btnCadastrarSalaComercial = new JButton("Salvar e continuar sala comercial");
		...
		btnCadastrarSalaComercial.setBounds(15, 443, 302, 29);
		...
		btnCadastrarApartamento.setBounds(15, 523, 300, 29);
